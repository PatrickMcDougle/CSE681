...
namespace CSE681.Project4.Core.Data
{
    public sealed class ChannelInformation : IEquatable<ChannelInformation>, IEqualityComparer<ChannelInformation>
    {
        ...
        public BlockingLinkedList<UserInformation> Chaters { get; private set; } = new BlockingLinkedList<UserInformation>();
        public DateTime Created { get; set; }
        public UserInformation HostInfo { get; set; }
        public Guid Id { get; set; }
        public bool IsCreatedByHost { get; set; } = false;
